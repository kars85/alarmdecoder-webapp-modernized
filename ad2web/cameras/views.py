...
def index():
    ...
    return render_template(
        "cameras/index.html", camera_list=camera_list, buttons=buttons, ssl=use_ssl
    )
...
def cam_list():
    ...
    return render_template(
        "cameras/cam_list.html", camera_list=camera_list, ssl=use_ssl, active="cameras"
    )
...
def edit_camera(camera_id):
    ...
    use_ssl = Setting.get_by_name("use_ssl", default=False).value
    return render_template(
        "cameras/edit_cam.html", form=form, camera_id=camera_id, active="cameras", ssl=use_ssl
    )
